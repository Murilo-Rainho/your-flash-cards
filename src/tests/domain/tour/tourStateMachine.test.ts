...
import { CURRENT_TOUR_VERSION, INITIAL_TOUR_STATE, type TourState } from '@/domain/tour/TourState';
import {
  completeTour,
  getTourProgress,
  goToNextStep,
...
import { BASE_TOUR_STEPS, type TourStep } from '@/domain/tour/tourSteps';
