...
export type StringCatalog = {
  ...
  importExport: {
    ...
    import: {
      ...
      fileLabel: string;
      previewTitle: string;
      readyToImportSingular: string;
      readyToImportPlural: string;
      skippedRowsSingular: string;
      skippedRowsPlural: string;
      mediaSkippedSingular: string;
      mediaSkippedPlural: string;
      rowPrefix: string;
      emptyParse: string;
      skipReasons: {
        'invalid-type': string;
      ...
      importError: string;
      resultTitle: string;
      importedSingular: string;
      importedPlural: string;
      notImportedSingular: string;
      notImportedPlural: string;
      doneLabel: string;
